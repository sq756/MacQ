 ...
 * @return Error code
 */
MacQError qstate_apply_toffoli(QuantumState* qs, int control1, int control2, int target);
 ...
 * @return Error code
 */
MacQError qstate_set_amplitude(QuantumState* qs, size_t basis_index, cplx amplitude);
